  ...
  >
    ...
    <div class="text-base m-10">
      <div class="flex flex-col text-center mb-10">
        <span class="animate-pulse font-black"> EM BREVE </span>
      </div>
      <ul class="flex flex-wrap blur-sm justify-center">
        <li class="flex flex-col">
          <div
            class="h-36 w-36 m-3 mr-2 p-5 rounded-3xl flex items-center bg-gray-900 animate-pulse"
          ></div>
