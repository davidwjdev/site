        ...
        return {
            experiencias: [
                ...
                },
                {
                    title: "HTML",
                    src: new URL(
                        `/src/assets/img/experiencia/html5.svg`,
                        import.meta.url
                    ).href
                },
                {
                    title: "CSS",
                    src: new URL(
                        `/src/assets/img/experiencia/css3.svg`,
                        import.meta.url
                    ).href
                },
                {
                    title: "SCSS/SASS",
                    src: new URL(
                        `/src/assets/img/experiencia/sass.svg`,
                        import.meta.url
                    ).href
                },
                {
                ...
                },
                {
                    title: "Figma",
                    src: new URL(
                        `/src/assets/img/experiencia/figma.svg`,
                        import.meta.url
                    ).href
                }
            ],
            conhecimentos: [
                ...
                },
                {
                    title: "PHP",
                    src: new URL(
                        `/src/assets/img/conhecimento/php.svg`,
                        import.meta.url
                    ).href
                },
                {
...
<template>
    <div
        class="md:w-8/12 rounded-lg mb-24 bg-black bg-opacity-60 md:shadow-lg md:shadow-black sm:m-5"
    >
        <div>
            ...
            <div class="text-base m-10">
                <ul class="flex flex-wrap">
                    <li
                        ...
                        :key="index"
                        class="cursor-default m-3 mr-2 p-3 rounded-lg flex items-center bg-neutral-800 md:hover:bg-neutral-700"
                    >
                        <img
                            :src="item.src"
                            :alt="item.title"
    ...
    >
        <div>
            <h2 class="md:text-3xl sm:text-2xl font-bold m-10">
                CONHECIMENTOS
            </h2>
            <div class="text-base m-10">
                <ul class="flex flex-wrap">
